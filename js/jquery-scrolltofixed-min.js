...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>ScrollToFixed/jquery-scrolltofixed-min.js at master · bigspotteddog/ScrollToFixed</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars3.githubusercontent.com/u/865101?v=3&amp;s=400" property="og:image" /><meta content="bigspotteddog/ScrollToFixed" property="og:title" /><meta content="https://github.com/bigspotteddog/ScrollToFixed" property="og:url" /><meta content="ScrollToFixed - This plugin is used to fix elements on the page (top, bottom, anywhere); however, it still allows the element to continue to move left or right with the horizontal scroll." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="4672CE4E:5F98:7895516:546173EB" name="octolytics-dimension-request_id" /><meta content="8485027" name="octolytics-actor-id" /><meta content="emzuniga" name="octolytics-actor-login" /><meta content="6fe34d6693535ec617d46c6897e22feeaba54d6e9c5e4822b2cf69587cc7b4d1" name="octolytics-actor-hash" />
...
<meta content="fAQlP0NRlU6fjorG2QBuntkpyU1GdEZHpMd4HHffkOMI3DSf5CG5Vav8OmyA3Fs9tyH82zC1B+BVf8EVu43UBg==" name="csrf-token" />
...
<ul class="header-nav user-nav right" id="user-links">
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name" href="/emzuniga" data-ga-click="Header, go to profile, text:username">
      <img alt="Elaine" class="avatar" data-user="8485027" height="20" src="https://avatars2.githubusercontent.com/u/8485027?v=3&amp;s=40" width="20" />
      <span class="css-truncate">
        <span class="css-truncate-target">emzuniga</span>
      </span>
    </a>
  </li>
...
<ul class="dropdown-menu">
  ...
  <li>
    ...
    <li class="dropdown-header">
      <span title="bigspotteddog/ScrollToFixed">This repository</span>
    </li>
      <li>
        <a href="/bigspotteddog/ScrollToFixed/issues/new"><span class="octicon octicon-issue-opened"></span> New issue</a>
      </li>
</ul>
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Cp477C60OsDU9R0DLGuh7mFC1kzuszBquh5tnv7pcgxNlwEsv+252EfJJroJr2VKyXTBlg6l6SRnzf0E40jD/g==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="5GEtF0QUI6exu36KZzG2ZIkWsDkOriqmYfZ70DbBQiWYuKEUnxQfhd+YTflvl64Cj+75SD8UHCEEocT0TZWmZw==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="1931236" />

    <div class="select-menu js-menu-container js-select-menu">
      <a class="social-count js-social-count" href="/bigspotteddog/ScrollToFixed/watchers">
        65
      </a>
      <a href="/bigspotteddog/ScrollToFixed/subscription"
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/bigspotteddog/ScrollToFixed/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="jRA8l5G1Rue2AFn+5tgRG/2y/A7gEodqytxTTkDHafltxANeBiBHHg+mCmNflAGBX+b+s38h72vPB77yPTVPiQ==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
        aria-label="Unstar this repository" title="Unstar bigspotteddog/ScrollToFixed">
    ...
    <form accept-charset="UTF-8" action="/bigspotteddog/ScrollToFixed/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="nVqqv3Z7Kbht+IkYlZglsz0O03FA6S2lwL443nbNmBVXQ+UnCljyL9NNU+c5pOQnB2zzwKiXjzxw0vgNh0MHVQ==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
        aria-label="Star this repository" title="Star bigspotteddog/ScrollToFixed">
        <span class="octicon octicon-star"></span>
        Star
      </button>
        <a class="social-count js-social-count" href="/bigspotteddog/ScrollToFixed/stargazers">
        ...
        <li>
          <a href="/bigspotteddog/ScrollToFixed/fork" class="minibutton with-count js-toggler-target fork-button tooltipped-n" title="Fork your own copy of bigspotteddog/ScrollToFixed to your account" aria-label="Fork your own copy of bigspotteddog/ScrollToFixed to your account" rel="facebox nofollow">
            <span class="octicon octicon-repo-forked"></span>
            Fork
          </a>
          <a href="/bigspotteddog/ScrollToFixed/network" class="social-count">314</a>
        </li>
       ...
       --><strong><a href="/bigspotteddog/ScrollToFixed" class="js-current-repository js-repo-home-link" data-pjax-container-selector="#js-repo-pjax-container">ScrollToFixed</a></strong>
...
<nav class="sunken-menu repo-nav js-repo-nav js-sidenav-container-pjax js-octicon-loaders" role="navigation" data-issue-count-url="/bigspotteddog/ScrollToFixed/issues/counts" data-pjax-container-selector="#js-repo-pjax-container">
  <ul class="sunken-menu-group">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pull Requests">
      ...
      <li class="tooltipped tooltipped-w" aria-label="Wiki">
        <a href="/bigspotteddog/ScrollToFixed/wiki" aria-label="Wiki" class="js-selected-navigation-item sunken-menu-item js-disable-pjax" data-hotkey="g w" data-selected-links="repo_wiki /bigspotteddog/ScrollToFixed/wiki">
  ...
  <ul class="sunken-menu-group">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pulse">
      <a href="/bigspotteddog/ScrollToFixed/pulse" aria-label="Pulse" class="js-selected-navigation-item sunken-menu-item" data-pjax="true" data-selected-links="pulse /bigspotteddog/ScrollToFixed/pulse">
...
<div class="clone-url "
  ...
  <div class="input-group">
    <input type="text" class="input-mini input-monospace js-url-field"
           value="git@github.com:bigspotteddog/ScrollToFixed.git" readonly="readonly">
    <span class="input-group-button">
      <button aria-label="Copy to clipboard" class="js-zeroclipboard minibutton zeroclipboard-button" data-clipboard-text="git@github.com:bigspotteddog/ScrollToFixed.git" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
    </span>
  </div>
</div>
...
<p class="clone-options">You can clone with
  ...
  <a href="http://mac.github.com" data-url="github-mac://openRepo/https://github.com/bigspotteddog/ScrollToFixed" class="minibutton sidebar-button js-conduit-rewrite-url" title="Save bigspotteddog/ScrollToFixed to your computer and use it in GitHub Desktop." aria-label="Save bigspotteddog/ScrollToFixed to your computer and use it in GitHub Desktop.">
...
<div class="select-menu js-menu-container js-select-menu left">
  ...
  <div class="button-group right">
    ...
    <button aria-label="Copy to clipboard" class="js-zeroclipboard minibutton zeroclipboard-button" data-clipboard-text="jquery-scrolltofixed-min.js" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
  </div>
  ...
  <div class="commit file-history-tease">
    <div class="file-history-tease-header">
        ...
        <time datetime="2014-06-12T03:30:49Z" is="relative-time">Jun 11, 2014</time>
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a class="octicon-button tooltipped tooltipped-nw js-conduit-openfile-check"
             ...
             data-url="github-mac://openRepo/https://github.com/bigspotteddog/ScrollToFixed?branch=master&amp;filepath=jquery-scrolltofixed-min.js"
             ...
             data-failed-title="Your version of GitHub for Mac is too old to open this file. Try checking for updates.">
              ...
              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 ...
                 href="/bigspotteddog/ScrollToFixed/edit/master/jquery-scrolltofixed-min.js"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/bigspotteddog/ScrollToFixed/delete/master/jquery-scrolltofixed-min.js"
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.04119s from github-fe137-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
